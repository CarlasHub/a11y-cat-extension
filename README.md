...
Public documentation, privacy information, support guidance, screenshots, and internal Chrome status assets for A11Y Cat Extension.
...
- [Internal Chrome status](https://carlashub.github.io/a11y-cat-extension/docs/chrome-store-submission.html)
...
This repository intentionally contains only public-facing documentation and assets for the internal Chrome release boundary. It does not contain the private extension implementation, internal install links, private release evidence, local environment files, or internal planning documents.
